...
## Installation
You can download the [**repository**](https://github.com/AutoBotCorp/blum) by cloning it to your system and installing the necessary dependencies:
```shell
git clone https://github.com/AutoBotCorp/blum.git
cd blum
```
